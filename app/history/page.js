...
export default function HistoryPage() {
  ...
  const requestedPreset = String(searchParams.get("preset") ?? "").trim().toUpperCase();
  const requestedStartDayKey = String(searchParams.get("startDayKey") ?? "").trim();
  const requestedEndDayKey = String(searchParams.get("endDayKey") ?? "").trim();
